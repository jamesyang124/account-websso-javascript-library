...
| initView        | required | String      | <p>for landing view, default should set to <strong>sign-in,</strong> or value as:<br>1. <strong>sign-in</strong><br>2. <strong>sign-up</strong><br><strong></strong>3. <strong>auth-pincode</strong></p>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
| scopes          | optional | String List | scope array, so the auth key can be constraint to certain scopes. Currently only preset for VIVEPORT Desktop                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
